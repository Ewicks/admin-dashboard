        ...
        h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className='text-2xl'>£60,450.34</p>
            </div>
          </div>
          <div className='mt-6'>
          ...
          {earningData.map((item) => (
            <div key={item.title} className='bg-white dark:text-gray-200
             dark:bg-secondary-dark-bg md:w-56 p-4 pt-9 rounded-2xl'>
              <button type='button' style={{ color: item.itemColor, backgroundColor: item.iconBg}}
           ...
           dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
            ...
            <div className='empty-10 flex gap-10 flex-wrap justify-center'>
              <div className='border-r-1 border-color m-4 pr-10'>
                <div>
                  <p>
                    <span className='text-3xl font-semibold'>£93,938</span>
                ...
                <div className='mt-8'>
                  <p>
                    <span className='text-3xl font-semibold'>£200,938</span>
                  </p>
